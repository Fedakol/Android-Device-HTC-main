...
PRODUCT_NAME := mirea it1 # кодовое имя продукта, указывается в ro.product.name в файле build.prop
PRODUCT_BRAND := MIREA # бренд, указывается в ro.product.brand в файле build.prop
PRODUCT_MODEL := MIREA IT1 # модель, указывается в ro.product.model в файле build.prop
PRODUCT_MANUFACTURER := MIREA # производитель, указывается в ro.product.manufacturer в файле build.prop
