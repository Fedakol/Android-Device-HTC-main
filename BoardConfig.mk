TARGET_BOARD_PLATFORM := sdm845 # платформа, на которой построено устройство
# Architecture
TARGET_ARCH := arm64 # основная архитектура процессора
TARGET_ARCH_VARIANT := armv8-a # вариант архитектуры armv8-a
...
TARGET_CPU_ABI2 :=
TARGET_CPU_VARIANT := cortex-a75 # тип ядра процессора

TARGET_2ND_ARCH := arm # вторая поддерживаемую архитектуру процессором
TARGET_2ND_ARCH_VARIANT := armv8-a # вариант архитектуры armv8-a
...
TARGET_2ND_CPU_ABI2 := armeabi # тип ядра процессора
TARGET_2ND_CPU_VARIANT := cortex-a53 # тип ядра процессора

# Kernel
TARGET_KERNEL_SOURCE := kernel/mirea/it1 # путь к исходному коду ядра.
TARGET_KERNEL_CONFIG := it_defconfig # имя конфигурационного файла для сборки ядра.
